...
class RealRobotCubeEnv(gym.GoalEnv):
    ...
    def __init__(
        ...
        episode_length: int = task.EPISODE_LENGTH,
        path: str = None,
    ):
        """Initialize.
        ...
        self.trajectory = cube_goal_pose
        if self.trajectory is not None:
            task.validate_goal(self.trajectory)
        ...
        if self.action_type == ActionType.TORQUE:
            ...
            self.initial_action = INIT_JOINT_CONF  # self.initial_action = trifingerpro_limits.robot_position.default
    ...
    def step(self, action):
        ...
        for _ in range(num_steps):
            ...
            reward += self._compute_reward(observation['achieved_goal']['position'],
                                           observation['desired_goal']['position'], self.info)
            self.prev_observation = observation
    ...
    def _reset_direct_simulation(self):
        ...
        self.info = {'time_index': -1, 'trajectory': self.trajectory}
    ...
    def _create_observation(self, t, action):
        ...
        self.goal['position'] = np.asarray(task.get_active_goal(self.info['trajectory'], t))
        observation = {
            "robot": {
