...
# from winner1.code.make_env import make_training_env
from rrc_example_package.solution.make_env import make_training_env
from winner1.code.state_machine import TriFingerStateMachine
from winner1.code.utils import set_seed
...
def main():
    ...
    # takes a goal from a file, or randomly samples it
    if len(sys.argv) == 3:
